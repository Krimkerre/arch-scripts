...
function NEEDEDPKGS() {
  ...
  sleep 3
  pacstrap /mnt neofetch git wget rsync htop openssh archlinux-wallpaper glances python-defusedxml bashtop packagekit reflector bat mc lynx ncdu bwm-ng lsd gtop # bpytop
}
