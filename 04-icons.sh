...
yay -S --noconfirm --needed --asdeps boston-icon-theme
yay -S --noconfirm --needed --asdeps chicago95-icon-theme-git
yay -S --noconfirm --needed --asdeps qogir-icon-theme-git
