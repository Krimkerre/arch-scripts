...
sleep 2
yay -S --noconfirm --needed --asdeps gnome-shell-extension-dash-to-dock-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-dash-to-panel
yay -S --noconfirm --needed --asdeps gnome-shell-extension-arc-menu-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-freon-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-openweather-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-topicons-redux
yay -S --noconfirm --needed --asdeps gnome-shell-extension-audio-output-switcher-git
#yay -S --noconfirm --needed --asdeps gnome-shell-extension-shelltime-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-vitals-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-drop-down-terminal-x-git
...
yay -S --noconfirm --needed --asdeps gnome-shell-extension-blyr-git
yay -S --noconfirm --needed --asdeps gnome-shell-extension-dynamic-battery-git
...
yay -S --noconfirm --needed --asdeps gnome-shell-extension-workspaces-to-dock-git
